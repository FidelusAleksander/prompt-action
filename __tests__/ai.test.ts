...
describe('generateAIResponse', () => {
  ...
  it('should call OpenAI with response_format when schema is provided', async () => {
  ...
  it('should call OpenAI without response_format when no schema is provided', async () => {
    const mockResponse = 'Test response'
    openai.mockCreate.mockResolvedValueOnce({
      id: 'chatcmpl-123',
      object: 'chat.completion',
